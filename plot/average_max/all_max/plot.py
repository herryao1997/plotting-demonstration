...
# 第一个文件的路径和名称
file1 = 'center_max_0.5.txt'
# 第二个文件的路径和名称
file2 = 'side_max_0.5.txt'
# 第三个文件的路径和名称
file3 = 'center_max_1.txt'
# 第四个文件的路径和名称
file4 = 'side_max_1.txt'
# 第五个文件的路径和名称
file5 = 'center_max_1.5.txt'
# 第六个文件的路径和名称
file6 = 'side_max_1.5.txt'
# 第七个文件的路径和名称
file7 = 'center_max_1.67.txt'
# 第八个文件的路径和名称
file8 = 'side_max_1.67.txt'
...
# # 绘制第一个文件的数据
# ax.plot(x1, y1, color='blue', label='center_average_velocity_0.5')
# #
# # 绘制第二个文件的数据
# ax.plot(x2, y2, color='red', label='side_average_velocity_0.5')
#
# # 绘制第三个文件的数据
# ax.plot(x3, y3, '--', color='blue', label='center_average_velocity_1.0')
# #
# # 绘制第四个文件的数据
# ax.plot(x4, y4, '--', color='red', label='side_average_velocity_1.0')
#
# # 绘制第五个文件的数据
...
#
# # 绘制第七个文件的数据
# ax.plot(x7, y7, '-o', color='blue', label='center_average_velocity_1.67')
# #
# # 绘制第八个文件的数据
# ax.plot(x8, y8, '-o', color='red', label='side_average_velocity_1.67')
...
# plt.savefig("ave_massfraction.png")
# 显示图表
plt.show()
