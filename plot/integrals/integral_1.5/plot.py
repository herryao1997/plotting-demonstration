...
# 绘制第一个文件的数据
ax.plot(x1, y1, color='blue', label='center_maximum_velocity_1.5')
# ax.plot(x1, y1, color='blue', label='side_maximum_velocity_1.5')
...
# ax.text(0.21, 0.075, f'total particle: ${integral_value:.4f}$', color='red', fontsize=12, transform=ax.transAxes)
ax.text(0.36, 0.025, f'total particle: ${integral_value:.4f}$', color='red', fontsize=12, transform=ax.transAxes)
plt.savefig("centerwall_integral_1.5.png")
# plt.savefig("sidewall_integral_1.5.png")
# 显示图表
plt.show()
